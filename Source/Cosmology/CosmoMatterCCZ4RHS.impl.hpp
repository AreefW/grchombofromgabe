...
#if !defined(COSMOMATTERCCZ4RHS_HPP_)
#error "This file should only be included through CosmoMatterCCZ4RHS.hpp"
#endif

#ifndef COSMOMATTERCCZ4RHS_IMPL_HPP_
#define COSMOMATTERCCZ4RHS_IMPL_HPP_
#include "DimensionDefinitions.hpp"

template <class matter_t, class deriv_t>
CosmoMatterCCZ4RHS<matter_t, deriv_t>::CosmoMatterCCZ4RHS(
    ...
    : CCZ4RHS<gauge_t, deriv_t>(a_params, a_dx, a_sigma, a_formulation,
      ...
      my_matter(a_matter), m_G_Newton(a_G_Newton), m_K_mean(a_K_mean)
{
}

template <class matter_t, class deriv_t>
void CosmoMatterCCZ4RHS<matter_t, deriv_t>::set_K_mean(double a_K_mean)
{
    m_K_mean = a_K_mean;
}
...
void CosmoMatterCCZ4RHS<matter_t, deriv_t>::compute(
...
template <class matter_t, class deriv_t>
template <class data_t>
void CosmoMatterCCZ4RHS<matter_t, deriv_t>::add_emtensor_rhs(
...
#endif /* COSMOMATTERCCZ4RHS_IMPL_HPP_ */