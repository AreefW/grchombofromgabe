...
template <class potential_t = DefaultPotential> class ScalarField
{
  ...
  public:
    ...
    {
        data_t phi;   // inflaton field
        data_t Pi;    // inflaton conjugate momentum
        data_t axion; // axion field (kinetically coupled)
        data_t Pi_axion; // axion conjugate momentum
        ...
        void enum_mapping(mapping_function_t mapping_function)
        {
            ...
            VarsTools::define_enum_mapping(mapping_function, c_axion, axion);
            VarsTools::define_enum_mapping(mapping_function, c_Pi_axion, Pi_axion);
        }
    };
    ...
    void emtensor_excl_potential(
        ...
        const Tensor<3, data_t>
            &chris_ULL) const; //!< the conformal christoffel symbol
