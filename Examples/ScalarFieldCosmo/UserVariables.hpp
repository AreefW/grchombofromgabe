...
enum
{
    ...
    c_phi = NUM_CCZ4_VARS, // inflaton field
    c_Pi,                  // inflaton conjugate momentum
    c_axion,               // axion field (kinetically coupled to inflaton)
    c_Pi_axion,            // axion conjugate momentum
...
static const std::array<std::string, NUM_VARS - NUM_CCZ4_VARS>
    user_variable_names = {"phi", "Pi", "axion", "Pi_axion"};
